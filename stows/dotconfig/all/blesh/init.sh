...
# bleopt accept_line_threshold=-10
...
bleopt complete_auto_delay=400
...
bleopt highlight_timeout_async=50
bleopt highlight_eval_word_limit=20000
...
ble-face -s syntax_command fg=orange
...
ble-face -s filename_orphan underline,fg=red,bg=224
