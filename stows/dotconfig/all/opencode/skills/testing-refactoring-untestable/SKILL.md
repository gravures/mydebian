---
name: testing-refactoring-untestable
description: >-
    Provides guidance for refactoring a code that is difficult to test (mixed I/O,
    missing inverses, ...). Use when writing tests, refactoring code to enable
    or improve testing.
---

# Refactoring for Property-Based Testing

Identify code that could be refactored to enable or improve testing (mainly
focused on property-based testing approach).
