...
name: python-design
description: >-
    Python design patterns including KISS, Separation of Concerns, Single
    Responsibility, and composition over inheritance. Use when making architecture
    decisions, refactoring code structure, or evaluating when abstractions are
    appropriate.
---
...
These patterns help you build systems that are easy to understand, test, and modify.
...
Choose the simplest solution that works. Complexity must be justified
...
The factory pattern adds code without adding value here. Save patterns
for when they solve real problems.
