---
name: testing-property-based-review
description: >-
    Evaluate quality of property-based tests. Use when reviewing tests
...
- reviewing existing property-based tests
- completing property-based tests for better coverage
- improving property-based tests with missing properties or poor settings
