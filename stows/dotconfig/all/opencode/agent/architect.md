...
description: >-
  ...
  assistant: "Let me engage the @architect agent to analyze this
  ...
  trade-offs, and structural impact. The @architect agent should provide
  ...
  assistant: "I'll use the @architect agent to redesign the module
  structure and recommend patterns for better organization."

  <commentary>

  The user needs structural redesign of existing code. The @architect
