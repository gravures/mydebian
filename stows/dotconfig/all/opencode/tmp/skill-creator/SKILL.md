...
Skills are **SOPs/workflows**, NOT agents. DO NOT use role descriptions like
"You are a..." or "[Role] expert.". Before loading, the agent sees only the **name**
and **description** in `<available_skills>`:
...
**Description pattern (LLM-optimized)** (dense, machine-parseable, specific. Avoid prose):
