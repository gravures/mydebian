...
sys.path.append(str(Path("~/DEV/REPOS/standard-deluxe/src").expanduser()))
c = get_config()
...
c.InteractiveShellApp.extensions.append("trepanmagic")
...
#  startup.
#  Default: 1000
c.InteractiveShell.history_load_length = 500
...
#  Default: ''
c.TerminalInteractiveShell.prompt_line_number_format = "{line:3d} "
